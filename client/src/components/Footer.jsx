          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                ...
                <span className="text-gray-400 text-sm">MG Road, Hubli, Karnataka, 580029, India</span>
              </li>
              <li className="flex items-center space-x-3">
                <FaEnvelope className="text-primary-400 flex-shrink-0" />
                <a href="mailto:info@eventhub.com" className="text-gray-400 text-sm hover:text-primary-400">info@eventhub.com</a>
              </li>
              <li className="flex items-center space-x-3">
                <FaPhone className="text-primary-400 flex-shrink-0" />
                <a href="tel:+919876543210" className="text-gray-400 text-sm hover:text-primary-400">+91 98765 43210</a>
              </li>
            </ul>
          </div>
        </div>
